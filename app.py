...
@app.route("/disclaimer"); def disclaimer(): return render_template("static_page.html",title="Disclaimer",content_key="disclaimer")
...
# ADMIN ROUTES
# ═══════════════════════════════════════════════════════════════════════════════
@app.route("/admin/"); @app.route("/admin/dashboard")
@login_required
def admin_dashboard():
...
@app.errorhandler(500); def server_error(e): return render_template("500.html"),500
