...
# ── Super Admin credentials (set these in Render ENV) ───────────────────────
...
# ── Firebase init (only FIREBASE_PRIVATE_KEY needed as ENV var) ───────────────
db = None
_private_key = os.environ.get("FIREBASE_PRIVATE_KEY", "").strip()
if _private_key:
    if "\\n" in _private_key:
    ...
    print("WARNING: FIREBASE_PRIVATE_KEY env not set. Database disabled.")
