...
def inject_globals():
    # The login page must stay available even when Firebase or site settings
    # are unavailable. It only needs the CSRF helper and has no dependency on
    # the public-site globals below.
...
def admin_dashboard():
    ...
    # FIX: total_views — sirf published articles ki saari views count karo, sirf 10 nahi
