...
def admin_profile():
    ...
    achievements=compute_achievements(session["admin_id"])
    return render_template("admin_profile.html",user=user,achievements=achievements,all_achievements=ACHIEVEMENTS)
